...
class SearchPagingSource (private val dataRepoHelper: DataRepositoryHelper, private val query: String) :
    PagingSource<Int, MovieItem>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieItem> {
            val nextPage = params.key ?: PAGE_INDEX
           return try {
                val response = dataRepoHelper.searchMoviesByQuery(query,nextPage)
